...
public class ArtistAdapter extends ArrayAdapter<Songs> {
    ...
    public ArtistAdapter(@NonNull Context context, ArrayList<Songs> songs) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.artist_list, parent, false);
        }

        // get the songs object located at this position in the list
        Songs currentSongs = getItem(position);

        // find the textview in the artist_list.xml layout with id artist_name
        ...
        // find the textview in the artist_list.xml layout with id song_name
        ...
        // find the imageview in the artist_list.xml layout with id song_img
        ImageView songView = listItemView.findViewById(R.id.artist_img);
